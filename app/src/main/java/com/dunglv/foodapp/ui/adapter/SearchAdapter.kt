...
class SearchAdapter : BaseBindingAdapter<DataProducts, ItemSearchBinding>(
    ...
    override fun onBindViewHolderBase(holder: BaseHolder<ItemSearchBinding>, position: Int) {
