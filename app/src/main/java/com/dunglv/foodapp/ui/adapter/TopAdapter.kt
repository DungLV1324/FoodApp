...
import com.dunglv.foodapp.databinding.ItemTopBinding
import com.dunglv.foodapp.ui.base.BaseBindingAdapter

class TopAdapter : BaseBindingAdapter<DataProducts, ItemTopBinding>(
    ...
    override fun onBindViewHolderBase(holder: BaseHolder<ItemTopBinding>, position: Int) {
