...
import com.dunglv.foodapp.databinding.ItemAllMenuBinding
import com.dunglv.foodapp.databinding.ItemFullFoodBinding
import com.dunglv.foodapp.ui.base.BaseBindingAdapter

class AllMenuAdapter : BaseBindingAdapter<DataProducts, ItemAllMenuBinding>(
    ...
    override fun onBindViewHolderBase(holder: BaseHolder<ItemAllMenuBinding>, position: Int) {
