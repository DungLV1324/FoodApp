...
import com.dunglv.foodapp.databinding.ItemPizzaBinding
import com.dunglv.foodapp.ui.base.BaseBindingAdapter

class PizzaAdapter : BaseBindingAdapter<DataProducts, ItemPizzaBinding>(
    ...
    override fun onBindViewHolderBase(holder: BaseHolder<ItemPizzaBinding>, position: Int) {
